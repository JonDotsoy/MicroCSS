...
decomposeCSS.prototype.toCSS = function() {
    var outputString = ''

    for (var key in this.objectCSSElement) {
        var objCSS = this.objectCSSElement[key]
        outputString += objCSS.toCSS()
    }
